...
main.py saves weights when it complete training. If you stop the training and start training again the program starts from the previously saved checkpoint. If you want to run the network without training and just see the result, running main.py alone will load last weights and redisplay results.
