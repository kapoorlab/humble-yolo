...
parser.add_argument('--batch_size', help='batch_size', const='int', nargs='?', default=100)
...
if args.train:
    ...
    print(model.summary())
    model.fit(x_train, y_train, batch_size= int(args.batch_size), epochs=int(args.epoch))
